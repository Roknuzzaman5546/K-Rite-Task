// THis Home team just design by html, css, javascript, react.js
            ...
            <div className="mt-5">
                <table className=" border w-full py-3 text-sm">
                    ...
                    <tr className=" border-t">
                        ...
                        <td className=" border-l">
                            <p className=" ml-2">
                                <span className=" text-purple-500 border bg-purple-100 border-purple-500 font-semibold p-[2px] rounded">Marketplace</span>
                            </p>
                        </td>
                        {/* tags part */}
                        <td className=" border-l"><p className=" ml-2 flex items-center space-x-1 line-clamp-1">
                        ...
                        {/* Next meeting part */}
                        <td className=" border-l"><p className=" ml-2">
                            <span className=" text-green-400 border border-green-400 bg-green-200 shadow-md  font-semibold p-[2px] rounded">In 6 hour</span>
                        </p>
                        </td>
                        <td className=" border-l w-8"><p className=" ml-2">+</p></td>
                    </tr>
                    ...
                    <tr className=" border-t">
                        ...
                        <td className=" border-l w-[110px]">
                            <div className=" flex items-center justify-between gap-2">
                                <div className=" flex items-center justify-center ml-2 gap-1">
                                    <img className="w-5 h-5 rounded-md" src="https://i.ibb.co/C2b6Qb6/images.png" alt="" />
                                    <p className=" font-bold">Disney</p>
                                </div>
                            </div>
                        </td>
                        {/* description part */}
                        <td className=" border-l text-sm">
                            <p className=" ml-2 line-clamp-1 font-bold">Introduce in a B2B solution</p>
                        </td>
                        {/* avatar part */}
                        <td className=" border-l">
                            <p className=" ml-2">
                        ...
                        {/* categories part */}
                        <td className=" border-l">
                            <p className=" ml-2 flex items-center space-x-1 line-clamp-1">
                                <span className=" text-yellow-400 border bg-yellow-100 border-yellow-400 font-semibold p-[2px] rounded">B2B</span>
                                <span className=" text-orange-500 border bg-orange-100 border-orange-500 font-semibold p-[2px] rounded">B2C</span>
                            </p>
                        </td>
                        {/* tags part */}
                        <td className=" border-l"><p className=" ml-2 flex items-center space-x-1 line-clamp-1">
                        ...
                        {/* Next meeting part */}
                        <td className=" border-l"><p className=" ml-2">
                            <span className=" text-red-800 border border-red-800 bg-red-200 shadow-md  font-semibold p-[2px] rounded">No connect</span>
                        </p>
                        </td>
                        <td className=" border-l w-8"><p className=" ml-2">+</p></td>
                    </tr>
                    ...
                    <tr className=" border-t">
                        ...
                        <td className=" border-l w-[160px]">
                            <div className=" flex items-center justify-between gap-2">
                                <div className=" flex items-center justify-between ml-2 gap-1">
                                    <img className="w-5 h-5 rounded-md" src="https://i.ibb.co/vLStfcg/Lightrome.png" alt="" />
                                    <p className=" font-bold">Lightsome</p>
                                </div>
                                <p className=" mr-2 flex items-center gap-1"><IoCopyOutline></IoCopyOutline> 9</p>
                            </div>
                        </td>
                        {/* description part */}
                        <td className=" border-l text-sm">
                        ...
                        <td className=" border-l">
                            <p className=" ml-2 space-x-1">
                                <span className=" text-blue-400 border bg-blue-100 border-blue-400 font-semibold p-[2px] rounded">Technology</span>
                                <span className=" text-green-400 border bg-green-100 border-green-400 font-semibold p-[2px] rounded">SASS</span>
                            </p>
                        </td>
                        {/* tags part */}
                        <td className=" border-l"><p className=" ml-2 flex items-center space-x-1 line-clamp-1">
                        ...
                        {/* Next meeting part */}
                        <td className=" border-l"><p className=" ml-2">
                            <span className=" text-green-400 border border-green-400 bg-green-200 shadow-md  font-semibold p-[2px] rounded">In 1 hour</span>
                        </p>
                        </td>
                        <td className=" border-l w-8"><p className=" ml-2">+</p></td>
                    </tr>
                    ...
                    <tr className=" border-t">
                        ...
                        <td className=" border-l w-[110px]">
                            <div className=" flex items-center justify-between gap-2">
                                <div className=" flex items-center justify-center ml-2 gap-1">
                                    <img className="w-5 h-5 rounded-md" src="https://i.ibb.co/fQvXsZN/Google.webp" alt="" />
                                    <p className=" font-bold">Google</p>
                                </div>
                                <p className=" mr-2 flex items-center gap-1"><IoCopyOutline></IoCopyOutline> 5</p>
                            </div>
                        </td>
                        {/* description part */}
                        <td className=" border-l text-sm">
                            <p className=" ml-2 line-clamp-1 font-bold">Google dev by personalized fitness</p>
                        </td>
                        {/* avatar part */}
                        <td className=" border-l">
                            <p className=" ml-2">
                                <div className="avatar-group -space-x-4 rtl:space-x-reverse">
                                    ...
                                    <div className="avatar placeholder">
                                        <div className="w-6 bg-base-300 text-slate-600">
                                            <span>+5</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <td className=" border-l">
                            <p className=" ml-2 flex items-center space-x-1 line-clamp-1">
                                <span className=" text-yellow-500 border bg-yellow-100 border-yellow-500 font-semibold p-[2px] rounded">France</span>
                                <span className=" text-purple-500 border bg-purple-100 border-purple-500 font-semibold p-[2px] rounded">Automation</span>
                            </p>
                        </td>
                        {/* tags part */}
                        ...
                        {/* Next meeting part */}
                        <td className=" border-l"><p className=" ml-2">
                            <span className=" text-green-400 border border-green-400 bg-green-200 shadow-md  font-semibold p-[2px] rounded">In 30 hour</span>
                        </p>
                        </td>
                        <td className=" border-l w-8"><p className=" ml-2">+</p></td>
                    </tr>
                    ...
                    <tr className=" border-t">
                        ...
                        <td className=" border-l w-[110px]">
                            <div className=" flex items-center justify-between gap-2">
                                <div className=" flex items-center justify-center ml-2 gap-1">
                                    <img className="w-5 h-5 rounded-md" src="https://i.ibb.co/wp094pK/Fiverr.png" alt="" />
                                    <p className=" font-bold">Fiver</p>
                                </div>
                            </div>
                        </td>
                        {/* description part */}
                        <td className=" border-l text-sm">
                            <p className=" ml-2 line-clamp-1 font-bold">Include app in an a Automation</p>
                        </td>
                        {/* avatar part */}
                        <td className=" border-l">
                            <p className=" ml-2">
                        ...
                        {/* Next meeting part */}
                        <td className=" border-l"><p className=" ml-2">
                            <span className=" text-slate-400 shadow-md  font-semibold p-[2px] rounded">Next month</span>
                        </p>
                        </td>
                        <td className=" border-l w-8"><p className=" ml-2">+</p></td>
                    </tr>
                    ...
                    <tr className=" border-t">
                        ...
                        <td className=" border-l w-[110px]">
                            <div className=" flex items-center justify-between gap-2">
                                <div className=" flex items-center justify-center ml-2 gap-1">
                                    <img className="w-5 h-5 rounded-md" src="https://i.ibb.co/X2qG5gw/logo-ms-social.png" alt="" />
                                    <p className=" font-bold">Microsoft</p>
                                </div>
                                <p className=" mr-2 flex items-center gap-1"><IoCopyOutline></IoCopyOutline> 14</p>
                            </div>
                        </td>
                        {/* description part */}
                        <td className=" border-l text-sm">
                            <p className=" ml-2 line-clamp-1 font-bold">Microsoft method by Paypal</p>
                        </td>
                        {/* avatar part */}
                        <td className=" border-l">
                            <p className=" ml-2">
                        ...
                        <td className=" border-l">
                            <p className=" ml-2 flex items-center space-x-1 line-clamp-1">
                                <span className=" text-purple-500 border bg-purple-100 border-purple-500 font-semibold p-[2px] rounded">Publishing</span>
                                <span className=" text-yellow-500 border bg-yellow-100 border-yellow-500 font-semibold p-[2px] rounded">BCC</span>
                            </p>
                        </td>
                        {/* tags part */}
                        <td className=" border-l"><p className=" ml-2 flex items-center space-x-1 line-clamp-1">
                        ...
                        {/* Next meeting part */}
                        <td className=" border-l"><p className=" ml-2">
                            <span className=" text-red-800 border border-red-800 bg-red-200 shadow-md  font-semibold p-[2px] rounded">Not Connected</span>
                        </p>
                        </td>
                        <td className=" border-l w-8"><p className=" ml-2">+</p></td>
                    </tr>
                    ...
                    <tr className=" border-t">
                        ...
                        <td className=" border-l w-[110px]">
                            <div className=" flex items-center justify-between gap-2">
                                <div className=" flex items-center justify-center ml-2 gap-1">
                                    <img className="w-5 h-5 rounded-md" src="https://i.ibb.co/PDZyXgj/inivition.png" alt="" />
                                    <p className=" font-bold">Inivition</p>
                                </div>
                            </div>
                        </td>
                        {/* description part */}
                        <td className=" border-l text-sm">
                            <p className=" ml-2 line-clamp-1 font-bold">Inivition personalized fitness</p>
                        </td>
                        {/* avatar part */}
                        <td className=" border-l">
                            <p className=" ml-2">
                        ...
                        <td className=" border-l">
                            <p className=" ml-2">
                                <span className=" text-blue-500 border bg-blue-100 border-blue-500 font-semibold p-[2px] rounded">Web series</span>
                            </p>
                        </td>
                        {/* tags part */}
                        <td className=" border-l"><p className=" ml-2 flex items-center space-x-1 line-clamp-1">
                    ...
                    <tr className=" border-t">
                        ...
                        <td className=" w-8"><p className=" ml-2"></p></td>
                    </tr>
                </table>
            </div>
            {/* Footer button */}
